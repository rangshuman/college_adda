<?php
    ...
    $query1 = "SELECT mgr_community_forum.votes.q_id, mgr_community_forum.question.q_title, mgr_community_forum.question.upvote, mgr_community_forum.question.downvote FROM mgr_community_forum.votes INNER JOIN mgr_community_forum.question ON mgr_community_forum.votes.q_id = mgr_community_forum.question.id WHERE reg_no=".$_GET['reg_no']." AND vote_value=".$_GET['downvote'];
    // var_dump($query1);
